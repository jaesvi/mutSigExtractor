...
assignSigPerMut <- function(
   ...
   if(F){
      vcf.file='/Users/lnguyen/hpc/cuppen/shared_resources/HMF_data/DR-104-update3/somatics/200706_HMFregCPCT_FR16615415_FR17038019_CPCT02070491/purple/CPCT02070491T.purple.somatic.vcf.gz'
      mode='snv'
      output='df'
